...
if not st.session_state['Player'] and not st.session_state['Computer']:
...
if st.session_state['Player'] and st.session_state['Computer']:
    results.add_rows([[converter[st.session_state['Player']], converter[st.session_state['Computer']]]])