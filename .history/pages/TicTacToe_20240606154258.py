...
def shoot():
    ...
    st.table(pd.DataFrame([st.session_state['PlayerScore'], st.session_state['ComputerScore'], st.session_state['#Draw']], columns=['Your Score', 'Computers Score', 'Number of Draws']))
