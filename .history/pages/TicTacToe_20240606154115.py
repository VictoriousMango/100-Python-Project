...
def shoot():
    ...
    st.table(pd.DataFrame([st.session_state[i] for i in ['PlayerScore', 'ComputerScore', '#Draw']], columns=['Your Score', 'Computers Score', 'Number of Draws']))
