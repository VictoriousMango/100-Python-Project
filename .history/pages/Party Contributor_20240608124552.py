...
class Distributor():
    ...
    def entryBalancePerPerson(self, Name, Spent, Receive):
        ...
        if Name in self.BalancePerPerson['Name']:
            # print(f"{Name} Exists")
            print(self.BalancePerPerson)
            self.BalancePerPerson['Have Spent'][self.BalancePerPerson['Name'].index(Name)] += Spent
            self.BalancePerPerson['Have Spent'][self.BalancePerPerson['Name'].index(Name)] += Receive
            self.BalancePerPerson['Net Total'][self.BalancePerPerson['Name'].index(Name)] = self.BalancePerPerson['Have Spent'][self.BalancePerPerson['Name'].index(Name)] - self.BalancePerPerson['Have Spent'][self.BalancePerPerson['Name'].index(Name)]
        else:
            # print(f"New entry for {Name} has been made")
