...
with st.expander("Rules"):
    st.write("Fire 10 units on opponents tower to win!")
    st.write("If your tower gets more than 5 hits, you loose.")
    st.write("You can fire from the towers getting damage, to reduce the damage.")
