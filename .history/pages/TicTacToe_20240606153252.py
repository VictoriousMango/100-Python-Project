...
def shoot():
    ...
    winCriteria = [
        st.session_state['Player'] == 'Rock' and st.session_state['Computer'] == 'Scissor',
        st.session_state['Player'] == 'Paper' and st.session_state['Computer'] == 'Rock',
        st.session_state['Player'] == 'Scissor' and st.session_state['Computer'] == 'Paper'   
    ]
    st.write(winCriteria)
    if winCriteria[0]:
